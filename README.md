...
```
INSTANCE_COUNT=1 DATADOG_API_KEY=asdfasdf CF_USER=asdfasdf CF_PASS=asdfasdf CF_ORG=cf-smoke-tests-org CF_SPACE=cf-smoke-tests-as-an-app-wootsauce CF_API=https://api.asdfasdf.com CF_APPS_DOMAIN=run.asdfasdf.com rake push
